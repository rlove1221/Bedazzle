...
#define BUTTON_IMAGE_OF_TOPCENTER   @"topCenter_n.png"
...
#define BUTTON_IMAGE_OF_TOPCENTER_H    @"topCenter_h.png"
...
@property (nonatomic,strong) UIViewController *topCenterController;
